...
flowchart TD
  ...
  n1{"tents_or_membrane_structures?"}
  start --> n1
  n2{"tent_max_sqft #gt; 400?"}
  n1 -->|yes| n2
  n2 -->|yes| r_sffd_tent_permit
  n3{"canopy_total_sqft #gt; 700?"}
  n1 -->|yes| n3
  n4{"canopy_firebreaks_12ft?"}
  n3 -->|yes| n4
  n4 -->|no| r_sffd_canopy_permit
  n5{"tent_occupant_load ≥ 50?"}
  n1 -->|yes| n5
  n5 -->|yes| r_sffd_tent_site_plan
  n6{"cooking_fuel_or_open_flame?"}
  start --> n6
  n6 -->|yes| r_sffd_cooking_permits
  n7{"generator_gasoline_gal #gt; 10?"}
  start --> n7
  n7 -->|yes| r_sffd_generator_permit
  n8{"generator_diesel_gal #gt; 60?"}
  start --> n8
  n8 -->|yes| r_sffd_generator_permit
  n9{"inflatables_flame_effects_or_flammable_liquids?"}
  start --> n9
  n9 -->|yes| r_sffd_other_operational_permits
  n10{"temporary_structures_or_construction?"}
  start --> n10
  n10 -->|yes| r_dbi_sffd_construction_review
...
flowchart TD
  ...
  n5{"open_water_swimming?"}
  start --> n5
  n6{"swimmers #gt; 100?"}
  n5 -->|yes| n6
  n6 -->|yes| r_event_medical_plan
  n7{"location in [street_or_sidewalk, city_park, port, treasure_island]?"}
  start --> n7
  n8{"peak_attendance #gt; 100?"}
  n7 -->|yes| n8
  n8 -->|yes| r_bottled_water_restriction
